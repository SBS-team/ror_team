...
tech.technologies << Technology.create(:name => 'Ruby', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/ruby-language.png'))))
tech.technologies << Technology.create(:name => 'Rails', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/rails_mini.png'))))
tech.technologies << Technology.create(:name => 'Git', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/git.png'))))
tech.technologies << Technology.create(:name => 'Bash', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/bash.png'))))
tech.technologies << Technology.create(:name => 'RVM', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/rvm.png'))))

tech = TechnologyCategory.create(:name => 'SQL & Databases')
tech.technologies << Technology.create(:name => 'MySQL', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/mysql.png'))))
tech.technologies << Technology.create(:name => 'Postgre SQL', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/postgresql.png'))))
tech.technologies << Technology.create(:name => 'Sqlite', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/sqlite.png'))))
tech.technologies << Technology.create(:name => 'MongoDB', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/MongoDB.png'))))

tech = TechnologyCategory.create(:name => 'Javascript')
tech.technologies << Technology.create(:name => 'JQuery', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/jquery.png'))))
tech.technologies << Technology.create(:name => 'Mootools', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/mootools1.png'))))
tech.technologies << Technology.create(:name => 'Backbone.js', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/backbone.png'))))

tech = TechnologyCategory.create(:name => 'UI')
tech.technologies << Technology.create(:name => 'Bootstrap', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/bootstrap.png'))))
tech.technologies << Technology.create(:name => 'Web-App', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/Webapp_Icon.png'))))

tech = TechnologyCategory.create(:name =>'Styling')
tech.technologies << Technology.create(:name => 'HTML', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/html5.png'))))
tech.technologies << Technology.create(:name => 'HAML', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/haml.jpeg'))))
tech.technologies << Technology.create(:name => 'CSS', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/css3.png'))))
tech.technologies << Technology.create(:name => 'SASS', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/sass.png'))))

tech = TechnologyCategory.create(:name => 'Testing')
tech.technologies << Technology.create(:name => 'Cucumber', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('db/data_seed/cucumber.jpeg'))))
...
tech.technologies << Technology.create(:name => 'Jasmine', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('test/factories/files/image.png'))))
tech.technologies << Technology.create(:name => 'Capybara', :upload_file => UploadFile.create(:img_name => File.open(Rails.root.join('test/factories/files/image.png'))))
